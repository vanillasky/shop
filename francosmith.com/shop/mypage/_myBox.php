...
if ($sess[m_no]){
	...
	$query = "
		select
				...
				b.grpnm_disp_type,
				wish.wish_count,
				b.dc_type, b.add_emoney_type, b.free_deliveryfee
		from ".GD_MEMBER." a
	...
	##2011/09/07 kmn 회원그룹별 혜택정보
	$grp_profit = Core::loader('group_profit')->getGroupProfit($tmp['grp_sno']);
...
$tpl = &$this;
$tpl->define('tpl', 'mypage/_myBox.htm');
