<?php /* Template_ 2.2.7 2016/01/10 09:56:33 /www/francotr3287_godo_co_kr/shop/data/skin_mobileV2/default/ord/order.htm 000028444 */ 
...
section#nm_order .sub_title .point {width:4px; height:22px; background:url('/shop/data/skin_mobileV2/default/common/img/bottom/icon_guide.png') no-repeat center left; float:left; margin-right:7px;}
...
<table>
	...
	<tr>
		...
		<td class="zipcode">
			<div>
			<input type="number" class="zonecode" name="zonecode" id="zonecode" size="5" readonly value="<?php echo $TPL_VAR["zonecode"]?>" />
			...
			<!--<button id="zipcode-btn" class="btn_zipcode" type="button" onclick="frmMake('<?php echo $GLOBALS["cfg"]["rootDir"]?>/proc/popup_address.php?isMobile=true&gubun=mobile','searchZipcode','',false)">우편번호</button>-->
...
<?php if($GLOBALS["sess"]){?>
	<tr>
		<th>회원정보<br/>반영</th>
		<td>
			<input type="checkbox" name="updateMemberInfo" value="y" /> 위 내용을 회원정보에 반영합니다.<br/>(주소/전화번호/핸드폰번호)
		</td>
	</tr>
<?php }?>
</table>
