<?php /* Template_ 2.2.7 2014/03/05 23:19:27 /www/francotr3287_godo_co_kr/shop/data/skin/campingyo/board/default/list.htm 000007647 */ 
...
<?php }?>
	...
	<tr>
<?php if(!($GLOBALS["bdField"]& 1)){?><td align=center height=30 background="/shop/data/skin/campingyo/board/default/img/board_bg.gif"><?php echo $TPL_VAR["link"]["chk"]?><img src="/shop/data/skin/campingyo/board/default/img/board_field_01.gif"><?php echo $TPL_VAR["link"]["end"]?></td><?php }?>
<?php if(!($GLOBALS["bdField"]& 2)){?><td align=center background="/shop/data/skin/campingyo/board/default/img/board_bg.gif"><img src="/shop/data/skin/campingyo/board/default/img/board_field_02.gif"></td><?php }?>
<?php if(!($GLOBALS["bdField"]& 4)){?>
<?php if($GLOBALS["bdUseSubSpeech"]){?><td align=center background="/shop/data/skin/campingyo/board/default/img/board_bg.gif"><?php echo $TPL_VAR["speechBox"]?></td><?php }?>
		<td align=center background="/shop/data/skin/campingyo/board/default/img/board_bg.gif"><img src="/shop/data/skin/campingyo/board/default/img/board_field_03.gif"></td>
<?php }?>
<?php if(!($GLOBALS["bdField"]& 8)){?><td align=center background="/shop/data/skin/campingyo/board/default/img/board_bg.gif"><img src="/shop/data/skin/campingyo/board/default/img/board_field_04.gif"></td><?php }?>
<?php if(!($GLOBALS["bdField"]& 16)){?><td align=center background="/shop/data/skin/campingyo/board/default/img/board_bg.gif"><img src="/shop/data/skin/campingyo/board/default/img/board_field_05.gif"></td><?php }?>
<?php if(!($GLOBALS["bdField"]& 32)){?><td align=center background="/shop/data/skin/campingyo/board/default/img/board_bg.gif"><img src="/shop/data/skin/campingyo/board/default/img/board_field_06.gif"></td><?php }?>
	</tr>
...
<?php if($TPL_V1["notice"]){?><img src="/shop/data/skin/campingyo/board/default/img/board_notice.gif" align=absmiddle><?php }else{?><?php echo $TPL_V1["num"]?><?php }?>
		</td>
<?php }?>
<?php if(!($GLOBALS["bdField"]& 4)){?>
<?php if($GLOBALS["bdUseSubSpeech"]){?><td width=50 nowrap><?php if($TPL_V1["category"]){?>[<?php echo $TPL_V1["category"]?>]<?php }?></td><?php }?>
		<td width=100% style="padding-left:10px">
		<?php echo $TPL_V1["gapReply"]?><?php if($TPL_V1["sub"]){?><img src="/shop/data/skin/campingyo/board/default/img/board_re.gif" align=absmiddle><?php }?>
...
<?php if($TPL_V1["secret"]){?><img src="/shop/data/skin/campingyo/board/default/img/icn_secret.gif" align=absmiddle><?php }?>
<?php if($TPL_V1["new"]){?><img src="/shop/data/skin/campingyo/board/default/img/board_new.gif" align=absmiddle><?php }?>
<?php if($TPL_V1["hot"]){?><img src="/shop/data/skin/campingyo/board/default/img/board_hot.gif" align=absmiddle border=0><?php }?>
		<?php echo $TPL_V1["xx"]?>
...
<?php }?>
			...
			<td><a href="javascript:document.frmList.submit()"><img src="/shop/data/skin/campingyo/board/default/img/board_btn_search.gif"></a></td>
			<td><a href="<?php echo url("board/list.php?")?>&id=<?php echo $TPL_VAR["id"]?>"><img src="/shop/data/skin/campingyo/board/default/img/board_btn_cancel.gif"></a></td>
		</tr>
		</table>
		</td>
	</tr>
...
<?php if($TPL_VAR["link"]["delete"]){?><?php echo $TPL_VAR["link"]["delete"]?><img src="/shop/data/skin/campingyo/board/default/img/board_btn_delete.gif"><?php echo $TPL_VAR["link"]["end"]?> <?php }?>
<?php if(!($GLOBALS["bdField"]& 1)){?><?php echo $TPL_VAR["link"]["viewSel"]?><img src="/shop/data/skin/campingyo/board/default/img/board_btn_view.gif"><?php echo $TPL_VAR["link"]["end"]?> <?php }?>
