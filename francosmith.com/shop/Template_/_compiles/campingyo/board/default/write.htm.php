<?php /* Template_ 2.2.7 2014/03/05 23:19:27 /www/francotr3287_godo_co_kr/shop/data/skin/campingyo/board/default/write.htm 000012389 */ ?>
<?php $this->print_("header",$TPL_SCP,1);?> <?php echo $GLOBALS["bdHeader"]?>


<?php if($GLOBALS["bdPrivateYN"]=="Y"&&is_file(sprintf("../skin/%s/service/_private_non.txt",$GLOBALS["cfg"]["tplSkin"]))){?>
<style>
.scroll	{
...
<?php if($GLOBALS["bdSecretChk"]==""||$GLOBALS["bdSecretChk"]=="0"||$GLOBALS["bdSecretChk"]== 1){?>
	<img src="/shop/data/skin/campingyo/board/default/img/board_secret.gif" align=absmiddle>
...
<?php if(count($TPL_VAR["file"])< 12){?>
	<tr>
		...
		<a href="javascript:add()"><img src="/shop/data/skin/campingyo/board/default/img/btn_upload_plus.gif" align=absmiddle></a>
		</td>
		<td id=prvImg0></td>
	</tr>
<?php }?>
...
<tr>
	...
	<td class=cell_L><?php echo $this->define('tpl_include_file_2',"proc/_captcha.htm")?> <?php $this->print_("tpl_include_file_2",$TPL_SCP,1);?></td>
</tr>
<?php }?>
...
<tr height=30>
	...
	<input type="image" src="/shop/data/skin/campingyo/board/default/img/board_btn_ok.gif" />
	<a href="javascript:document.frmWrite.reset()"><img src="/shop/data/skin/campingyo/board/default/img/board_btn_reset.gif"></a>
	<a href="javascript:history.back()"><img src="/shop/data/skin/campingyo/board/default/img/board_btn_back.gif"></a>
	</td>
</tr>
</table><p>
</form>
...
function add(){
	...
	tmpHTML = "<input type=file name='file[]' style='width:80%' class=line onChange='preview(this.value," + oTr.id +")'> <a href='javascript:del(" + oTr.id + ")'><img src='/shop/data/skin/campingyo/board/default/img/btn_upload_minus.gif' align=absmiddle></a>";
