<?php /* Template_ 2.2.7 2014/04/09 11:27:46 /www/francotr3287_godo_co_kr/shop/data/skin/campingyo/outline/header/standard.htm 000004694 */  $this->include_("dataBanner");?>
<a name="top"></a>
<div> <!--style="background:url(/shop/data/skin/campingyo/img/main/top_bg.jpg) repeat-x;height:129px;"-->
...
<?php }?> 
						...
						<td width="154" height="33" align="right"> 
							<!-- 검색 시작----------------------------------->
...
<?php }else{?>
								...
								?>
<?php }?>
								<table width="146" height="33" cellpadding="0" cellspacing="0" border="0" style="background:url(/shop/data/skin/campingyo/img/main/search_icon.jpg) no-repeat;">
									<tr>
					...
					<tr> 
						<!------------------ 상단로고 시작 ------------------->
						<td valign="top" colspan="3"><!-- 배너관리에서 수정가능 --><?php if((is_array($TPL_R1=dataBanner( 90))&&!empty($TPL_R1)) || (is_object($TPL_R1) && in_array("Countable", class_implements($TPL_R1)) && $TPL_R1->count() > 0)) {foreach($TPL_R1 as $TPL_V1){?><?php echo $TPL_V1["tag"]?><?php }}?></td>
						<!------------------ 상단로고 끝 -------------------> 
					</tr>
				</table>
			</td>
