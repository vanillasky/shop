...
<?php }else{?>
			...
			<input type="radio" name="save_mode" value="ncash"> 네이버 마일리지 <img src="<?php echo $GLOBALS["cfg"]["rootDir"]?>/proc/naver_mileage/images/n_mileage_on.png"/><br/>
<?php }?>
			<div id="save_button"><img src="/shop/data/skin/campingyo/img/nmileage/n_mileage_use.gif" onClick="javascript:cash_save_use();" class="mileage_button"> 버튼을 클릭해서 <span id="naver-mileage-accum-rate" style="color: #1ec228; font-weight: bold;"></span> 적립받고 사용하세요 <img class="n_mileage" src="/shop/data/skin/campingyo/img/nmileage/n_mileage_info2.gif" onclick="mileage_info();"></div>
