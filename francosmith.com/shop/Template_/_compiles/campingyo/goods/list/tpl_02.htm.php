<?php /* Template_ 2.2.7 2014/03/05 23:19:27 /www/francotr3287_godo_co_kr/shop/data/skin/campingyo/goods/list/tpl_02.htm 000003522 */ 
...
<tr>
	...
	<td>
<?php if($TPL_V1["coupon"]){?><div class=eng><b style="color:red"><?php echo $TPL_V1["coupon"]?></b> <img src="/shop/data/skin/campingyo/img/icon/good_icon_coupon.gif" align=absmiddle></div><?php }?>
...
<?php if($TPL_V1["consumer"]){?><div style="color:gray"><strike><?php echo number_format($TPL_V1["consumer"])?></strike> ↓</div><?php }?>
		<b style="color:#C94C00"><?php echo number_format($TPL_V1["price"])?>원</b> <?php if($TPL_V1["special_discount_amount"]){?><img src="/shop/data/skin/campingyo/img/icon/goods_special_discount.gif"><?php }?>
<?php }?>
