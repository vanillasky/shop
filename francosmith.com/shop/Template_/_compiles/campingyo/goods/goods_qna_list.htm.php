<?php /* Template_ 2.2.7 2014/03/05 23:19:27 /www/francotr3287_godo_co_kr/shop/data/skin/campingyo/goods/goods_qna_list.htm 000005213 */ 
...
<table border=0 cellpadding=0 cellspacing=0>
	<tr>
		<TD style="background: URL(/shop/data/skin/campingyo/img/common/bar_detail_04.gif) no-repeat;" nowrap width="163" height="24"></TD>
		<TD style="background: URL(/shop/data/skin/campingyo/img/common/bar_detail_04_bg.gif) repeat-x;" width='90%'></TD>
		<TD style="background: URL(/shop/data/skin/campingyo/img/common/bar_detail_04_right.gif) no-repeat;" nowrap width="10" height="24"></TD>
	</tr>
</table>
...
<a href="<?php echo url("goods/goods_qna.php")?>&" target="_parent"><img src="/shop/data/skin/campingyo/img/common/info_btn_totalview.gif"></a>
<a href="javascript:;" onclick="popup_register( 'add_qna', '<?php echo $GLOBALS["goodsno"]?>' )"><img src="/shop/data/skin/campingyo/img/common/btn_qna.gif"></a>
</div>
