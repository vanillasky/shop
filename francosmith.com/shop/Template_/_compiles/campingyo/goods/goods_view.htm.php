<?php /* Template_ 2.2.7 2015/03/01 01:45:14 /www/francotr3287_godo_co_kr/shop/data/skin/campingyo/goods/goods_view.htm 000058703 */  $this->include_("dataGoodsRelation","commoninfo");
...
<div id="el-multi-option-display" class="goods-multi-option">
	...
	<div style="font-size:12px;text-align:right;padding:10px 20px 10px 0;border-bottom:1px solid #D3D3D3;margin-bottom:5px;">
		<img src="/shop/data/skin/campingyo/img/common/btn_multioption_br.gif" align="absmiddle"> 총 금액 : <span style="color:#E70103;font-weight:bold;" id="el-multi-option-total-price"></span>
	</div>
</div>
<!-- / -->
...
<a href="../setGoods/?cody=<?php echo $TPL_VAR["goodsno"]?>"><img src="/shop/data/skin/campingyo/img/common/btn_codylink.gif"></a>
<?php }?>
<!-- 각종 버튼 -->
...
<?php }?>
<?php if($TPL_VAR["stocked_noti"]){?>
<a href="javascript:fnRequestStockedNoti('<?php echo $TPL_VAR["goodsno"]?>');"><img src="/shop/data/skin/campingyo/img/stocked_noti/btn_alarm_2.gif"></a>
<?php }?>
<a href="<?php echo url("goods/goods_list.php?")?>&category=<?php echo $_GET["category"]?>"><img src="/shop/data/skin/campingyo/img/common/btn_list.gif"></a>
</div>
...
<tr>
	...
	<table border=0 cellpadding=0 cellspacing=0>
	<tr>
		<TD style="background: URL(/shop/data/skin/campingyo/img/common/bar_detail_01.gif) no-repeat;" nowrap width="120" height="24"></TD>
		<TD style="background: URL(/shop/data/skin/campingyo/img/common/bar_detail_01_bg.gif) repeat-x;" width='90%'></TD>
		<TD style="background: URL(/shop/data/skin/campingyo/img/common/bar_detail_01_right.gif) no-repeat;" nowrap width="10" height="24"></TD>
	</tr>
	</table>
...
<?php if($TPL_VAR["coupon"]||$TPL_VAR["coupon_emoney"]){?>
	...
	<table>
	<tr>
		<td><img src="/shop/data/skin/campingyo/img/common/coupon_txt.gif"></td>
		<td>
		<table border=0 cellpadding=0 cellspacing=0>
		<tr>
...
<?php }else{?>
		<div style="font:bold 12px tahoma;color:#FF0000;text-align:center;padding:19px 40px 0 0;width:140px;height:54px;background:url('/shop/data/skin/campingyo/img/common/coupon0<?php echo ($TPL_V1["coupon_img"]+ 1)?>.gif');" onmouseover="cp_explain('<?php echo $TPL_I1?>');" onmouseout="cp_explain_close('<?php echo $TPL_I1?>');"><?php echo $GLOBALS["r_couponAbility"][$TPL_V1["ability"]]?><?php if(substr($TPL_V1["price"], - 1)!="%"){?><?php echo number_format($TPL_V1["price"])?>원<?php }else{?><?php echo $TPL_V1["price"]?><?php }?></div>
<?php }?>
...
<?php }?>
	...
	<!-- 상세 설명 -->
	<div id=contents style="width:100%;padding:10 10 10 0;overflow:hidden;"><table width="100%">
	<tr><td>
	...
	<table border=0 cellpadding=0 cellspacing=0>
	<tr>
		<TD style="background: URL(/shop/data/skin/campingyo/img/common/bar_detail_02.gif) no-repeat;" nowrap width="137" height="24"></TD>
		<TD style="background: URL(/shop/data/skin/campingyo/img/common/bar_detail_02_bg.gif) repeat-x;" width='90%'></TD>
		<TD style="background: URL(/shop/data/skin/campingyo/img/common/bar_detail_02_right.gif) no-repeat;" nowrap width="10" height="24"></TD>
	</tr>
	</table>
...
<?php if((is_array($TPL_R1=commoninfo())&&!empty($TPL_R1)) || (is_object($TPL_R1) && in_array("Countable", class_implements($TPL_R1)) && $TPL_R1->count() > 0)) {foreach($TPL_R1 as $TPL_V1){?>
	<table border=0 cellpadding=0 cellspacing=0>
	<tr>
		<TD style="background: URL(/shop/data/skin/campingyo/img/common/bar_detail_l.gif) no-repeat;" nowrap width="10" height="24"></TD>
		<TD style="background: URL(/shop/data/skin/campingyo/img/common/bar_detail_c.gif) repeat-x; font-weight:bold;" width='100%'><?php echo $TPL_V1["title"]?></TD>
		<TD style="background: URL(/shop/data/skin/campingyo/img/common/bar_detail_r.gif) no-repeat;" nowrap width="10" height="24"></TD>
	</tr>
	</table>
...
<?php }else{?>
	...
	<div class="flyer">
		<img src="http://francosmith.godohosting.com/shop/customer_notice_01.jpg"/>
		<img src="http://francosmith.godohosting.com/shop/customer_notice_02.jpg"/>
	</div>
		
	

	<!-- 결제안내
	<div style="height:26px; padding-top:10"><img src="/shop/data/skin/campingyo/img/common/bar_detail_07.gif"></div>
...
<tr>
	<td width="4" height="271" valign="top" background="/shop/data/skin/campingyo/img/common/page02_detail_blt.gif" style="background-repeat:no-repeat"></td>
	<td  width="285" height="271" valign="top" background="/shop/data/skin/campingyo/img/common/page02_detail.gif"></td>
</tr>
</table>
