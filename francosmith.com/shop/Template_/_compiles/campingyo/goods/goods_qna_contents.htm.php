<?php /* Template_ 2.2.7 2014/03/05 23:19:27 /www/francotr3287_godo_co_kr/shop/data/skin/campingyo/goods/goods_qna_contents.htm 000002009 */ ?>
...
<?php if($TPL_VAR["parent"]==$TPL_VAR["sno"]&&!$TPL_VAR["notice"]){?>
	<a href="javascript:;" onclick="popup_register( 'reply_qna', '<?php echo $TPL_VAR["goodsno"]?>', '<?php echo $TPL_VAR["sno"]?>' );"><img src="/shop/data/skin/campingyo/img/common/btn_reply.gif" border="0" align="absmiddle"></a>
<?php }?>
<?php if($TPL_VAR["authmodify"]=='Y'){?>
	<a href="javascript:;" onclick="popup_register( 'mod_qna', '<?php echo $TPL_VAR["goodsno"]?>', '<?php echo $TPL_VAR["sno"]?>' );"><img src="/shop/data/skin/campingyo/img/common/btn_modify2.gif" border="0" align="absmiddle"></a>
<?php }?>
<?php if($TPL_VAR["authdelete"]=='Y'){?>
	<a href="javascript:;" onclick="popup_register( 'del_qna', '<?php echo $TPL_VAR["goodsno"]?>', '<?php echo $TPL_VAR["sno"]?>' );"><img src="/shop/data/skin/campingyo/img/common/btn_delete.gif" border="0" align="absmiddle"></a>
<?php }?>
	</div>
	</td>
</tr>
