<?php /* Template_ 2.2.7 2014/03/05 23:19:40 /www/francotr3287_godo_co_kr/shop/data/skin/campingyo/mypage/mypage_qna_register.htm 000005740 */ ?>
<html>
<head>
...
<tr>
	...
	<div style="width:100%; background:#000000; border-bottom:2px solid #DDDDDD"><img src="/shop/data/skin/campingyo/img/common/popup_title_mantoman.gif"></div>
	<div><img src="/shop/data/skin/campingyo/img/common/space.gif" width=5 height=10></div>


	<CENTER>
	<div><img src="/shop/data/skin/campingyo/img/common/space.gif" width=5 height=5></div>
...
<?php }}?>
		...
		<tr>
			...
			<td>
			<input type=text name=ordno style="width:25%" value="<?php echo $GLOBALS["data"]["ordno"]?>"> <a href="javascript:order_open();"><img src="/shop/data/skin/campingyo/img/common/btn_inquiry_order.gif" align=absmiddle></a>
