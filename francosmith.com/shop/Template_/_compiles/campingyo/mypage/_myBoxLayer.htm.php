<?php /* Template_ 2.2.7 2014/03/05 23:19:40 /www/francotr3287_godo_co_kr/shop/data/skin/campingyo/mypage/_myBoxLayer.htm 000002375 */ ?>
<div id="MypageLayerBox" style="z-index:1000;position:absolute;border:1px solid #363636;background:#F6F6F6;width:187px;height:220px;display:none;text-align:center;">

	<div style="float:right;">
		<a href="javascript:void(0);" onClick="document.getElementById('MypageLayerBox').style.display='none';"><img src="/shop/data/skin/campingyo/img/main/close.gif"></a>
	</div>
	...
	<div>
		<a href="<?php echo url("member/myinfo.php")?>&"><img src="/shop/data/skin/campingyo/img/main/btn_mypage_go.gif"></a>
	</div>
