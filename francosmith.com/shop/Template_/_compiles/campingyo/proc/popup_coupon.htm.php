<?php /* Template_ 2.2.7 2014/03/05 23:19:40 /www/francotr3287_godo_co_kr/shop/data/skin/campingyo/proc/popup_coupon.htm 000007514 */ ?>
...
<tr>
	<td style="background:#000000; border-bottom:2px solid #DDDDDD"><img src="/shop/data/skin/campingyo/img/common/popup_title_coupon.gif"></td>
</tr>
<tr>
...
<?php }}?>
	...
	<div style="padding:10px" align=center><a href="javascript:window.close()"><img src="/shop/data/skin/campingyo/img/common/btn_confirm_red.gif"></a></div>
	</td>
</tr>


<tr>
	<td valign=bottom align=right style="padding:0 14 6 0;"><A HREF="javascript:this.close()" onFocus="blur()"><img src="/shop/data/skin/campingyo/img/common/popup_close.gif"></A></td>
</tr>
</table>
</body>
</html>