<?php /* Template_ 2.2.7 2016/05/04 13:19:30 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/mypage/mypage_orderview.htm 000034454 */  $this->include_("displayEggBanner");
...
<!-- 상단이미지 || 현재위치 -->
	...
	<div class="page_title_div">
		...
		<div class="page_path"><a href="/shop/">HOME</a> &gt; <a href="/shop/mypage/mypage.php">마이페이지</a> &gt; <span class='bold'>Order Details</span></div>
	</div>
...
<?php if($TPL_V1["addopt"]){?><div>[<?php echo str_replace("^","] [",$TPL_V1["addopt"])?>]</div><?php }?></a>
			...
			<td align=center><font color="#007fc8"><?php echo $GLOBALS["r_istep"][$TPL_V1["istep"]]?></FONT></td>
			<td align=center>
<?php if($GLOBALS["set"]["delivery"]["basis"]&&$TPL_V1["dvcode"]){?>
			<a href="javascript:popup('mypage_delivery.php?item_sno=<?php echo $TPL_V1["sno"]?>',600,600)"><img src="/shop/data/skin/freemart/img/common/btn_chase.gif"></a>
<?php }elseif(!$GLOBALS["set"]["delivery"]["basis"]&&$TPL_VAR["deliverycode"]){?>
			<a href="javascript:popup('mypage_delivery.php?ordno=<?php echo $TPL_VAR["ordno"]?>',600,600)"><img src="/shop/data/skin/freemart/img/common/btn_chase.gif"></a>
<?php }?>
<?php if($TPL_V1["istep"]== 4){?><a href="javascript:;" onclick="popup_register( 'add_review', '<?php echo $TPL_V1["goodsno"]?>' )"><img src="/shop/data/skin/freemart/img/common/btn_review.gif"></a><?php }?>
			</td>
		</tr>
...
<?php }}?>
		...
		<div style="text-align:left;width:100%;"><img src="/shop/data/skin/freemart/img/common/order_txt_01.gif" border=0></div>
...
<?php if($TPL_VAR["canceled_price"]){?>
				<tr>
					<td>취소금액</td>
					<td><?php echo number_format($TPL_VAR["canceled_price"])?>원</td>
				</tr>
<?php }?>
				<tr>
					<td>결제금액</td>
					<td><b><span id="paper_settlement"><?php echo number_format($TPL_VAR["prn_settleprice"])?></span>원</b></td>
				</tr>
<?php if($TPL_VAR["settleprice"]!=$TPL_VAR["prn_settleprice"]){?>
				<tr>
					<td>변경전 결제금액</td>
					<td><span id="paper_settlement"><?php echo number_format($TPL_VAR["settleprice"])?></span>원</td>
				</tr>
<?php }?>
				</table>
...
<?php if($TPL_VAR["step"]> 0&&$GLOBALS["egg"]["use"]=='Y'&&$TPL_VAR["eggyn"]=='f'){?>
		<table class="order-table-wrapper">
		<tr>
			<td class="order-section-title" style="padding-top:13px"><b>전자보증보험 재발급</b></td>
			<td id="orderbox">
...
<?php if($TPL_VAR["taxmode"]!=''&&!$TPL_VAR["cashreceipt"]){?>
		...
		<table class="order-table-wrapper">
		<tr>
			<td class="order-section-title" style="padding-top:13px"><b>세금계산서 발행신청</b></td>
			<td id="orderbox">
...
<?php if($GLOBALS["ableCashbag"]){?><!-- OK캐쉬백 -->
		<table class="order-table-wrapper">
		<tr>
			<td class="order-section-title"></td>
			<td id="orderbox">
			<div><a href="javascript:okcashbag();"><img src="/shop/data/skin/freemart/img/common/btn_okcash.gif"></a></div>
...
<?php if($GLOBALS["sess"]){?>
		<div align="right"  style="padding:5px 0">
			<font size=2 COLOR="#007FC8">※</font> <font color="#007fc8">주문취소/교환/반품을 원하시면 마이페이지의 <a href="<?php echo url("mypage/mypage_qna.php")?>&"><U>1:1문의게시판</U></A>을 이용하세요</font></div>
<?php }?>

		<div style="padding:20px" align=center id="avoidDblPay">
			<a href="javascript:history.back();"><img src="/shop/data/skin/freemart/img/common/back69.png" border=0></a>
<?php if($TPL_VAR["step"]== 0&&$TPL_VAR["step2"]== 0){?><a href="javascript:chkCancel();"><img src="/shop/data/skin/freemart/img/common/order_cancel.png" border=0></a><?php }?>
<?php if($GLOBALS["resettleAble"]){?><a href="javascript:chkReSettle();"><img src="/shop/data/skin/freemart/img/common/reorder.png" border=0></a></div><?php }?>
		<div style="font-size:0;height:5px"></div>
	</div><!-- End indiv -->
