...
<?php if($TPL_V1["ordno"]!='0'){?>
				<div class="order-no">[ 주문번호 <?php echo $TPL_V1["ordno"]?> 문의 ]</div>
<?php }?>
				<div class="description"><?php echo $TPL_V1["contents"]?></div>
				
				<div style="text-align:right;padding-bottom:5px;">
<?php if($TPL_V1["authreply"]=='Y'){?>
					<button class="button-small button-dark" onclick="popup_register( 'reply_qna', '<?php echo $TPL_V1["sno"]?>' );">답변</button>
<?php }?>
<?php if($TPL_V1["authmodify"]=='Y'){?>
					<button class="button-small button-dark" onclick="popup_register( 'mod_qna', '<?php echo $TPL_V1["sno"]?>' );">수정</button>
<?php }?>
<?php if($TPL_V1["authdelete"]=='Y'){?>
				    <button class="button-small button-dark" onclick="popup_register( 'del_qna', '<?php echo $TPL_V1["sno"]?>' );">삭제</button>
<?php }?>
			    </div>
			</div>
		</div>
