<?php /* Template_ 2.2.7 2016/04/06 21:50:07 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/mypage/_myBox.htm 000005153 */ ?>
<table id="mypage_box">
<col class=stxt width=80><col class=stxt align=right>
<tr>
	<td>회원그룹
<?php if($GLOBALS["sess"]["dc_type"]!='N'||$GLOBALS["sess"]["add_emoney_type"]!='N'||$GLOBALS["sess"]["free_deliveryfee"]!='N'){?>
		<br/>
		&nbsp;&nbsp;&nbsp;<a href="javascript: member_grp_pop();"><img src="/shop/data/skin/freemart/img/common/btn_benefit.gif"></a>
<?php }?>
	</td>
	<td class="right">
...
<tr>
	<td>적립금</td>
	<td class="right"><span class="number"><?php echo number_format($GLOBALS["sess"]["emoney"])?></span> 원</td>
</tr>
<tr>
	<td>할인쿠폰</td>
	<td class="right"><span class="number"><?php echo number_format($GLOBALS["sess"]["cnt_coupon"])?></span> 매</td>
</tr>
<tr>
	<td>장바구니</td>
	<td class="right"><a href="<?php echo url("goods/goods_cart.php")?>&"><span class="number"><?php echo number_format($GLOBALS["sess"]["cart_count"])?></span></a> 개</td>
</tr>
<tr>
	<td>위시리스트</td>
	<td class="right"><a href="<?php echo url("mypage/mypage_wishlist.php")?>&"><span class="number"><?php echo number_format($GLOBALS["sess"]["wish_count"])?></span></a> 개</td>
</tr>
</table>

<div id="MyMemberGrpBpx" style="z-index:10000;position:absolute;width:374px;height:220px;display:none;text-align:center;">

<div><img src="/shop/data/skin/freemart/img/common/benefit_01.gif"></div>
<div style="padding:0 25px 0 30px;width:374px;background:url(/shop/data/skin/freemart/img/common/benefit_02.gif) repeat-y top left;text-align:left;line-height:150%;font-size:12px;font-family:돋움; color:#464646; letter-spacing:-1; ">
	<div>
...
<div style="background: url('/shop/data/skin/freemart/img/common/benefit_03.gif'); width:374px; height:75px;">
	<div style="padding-top:25px;"></div>
	<a href="javascript:void(0);" onClick="document.getElementById('MyMemberGrpBpx').style.display='none'"><img src="/shop/data/skin/freemart/img/common/btn_benefit_check.gif"></a>
</div>
