<?php /* Template_ 2.2.7 2016/04/25 15:32:09 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/board/gallery/view.htm 000007743 */ 
...
<tr>
	<td class=eng style="padding:5px 5px">
...
<?php }?>
<tr>
	<td align=right class=eng style="padding:5px 5px">
...
<tr>
	...
	<tr>
		<td>
<?php if($TPL_V1["link"]["modify"]){?><?php echo $TPL_V1["link"]["modify"]?><img src="/shop/data/skin/freemart/board/gallery/img/btn_modify.jpg"><?php echo $TPL_VAR["link"]["end"]?> <?php }?>
<?php if($TPL_V1["link"]["delete"]){?><?php echo $TPL_V1["link"]["delete"]?><img src="/shop/data/skin/freemart/board/gallery/img/btn_delete.jpg"><?php echo $TPL_VAR["link"]["end"]?> <?php }?>
		</td>
		<td align=right>
...
<?php if((is_array($TPL_R2=$TPL_V1["relation"]["reply"])&&!empty($TPL_R2)) || (is_object($TPL_R2) && in_array("Countable", class_implements($TPL_R2)) && $TPL_R2->count() > 0)) {foreach($TPL_R2 as $TPL_V2){?>
	<tr>
		<td height=20><?php echo $TPL_V2["gapReply"]?><?php if($TPL_V2["sub"]){?><img src="/shop/data/skin/freemart/board/gallery/img/board_re.gif" align=absmiddle><?php }?><?php echo $TPL_V2["link"]["view"]?><?php echo $TPL_V2["subject"]?></a></td>
	</tr>
<?php }}?>
	</table>
