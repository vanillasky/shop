<?php /* Template_ 2.2.7 2016/04/25 15:17:50 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/board/default/write.htm 000012123 */ ?>
...
<?php if($GLOBALS["bdSecretChk"]==""||$GLOBALS["bdSecretChk"]=="0"||$GLOBALS["bdSecretChk"]== 1){?>
	<img src="/shop/data/skin/freemart/board/default/img/board_secret.gif" align=absmiddle>
...
<tr>
	<td align=right  valign=top style="padding-top:10">업로드</td>
	<td class=cell_L>
...
<?php if(count($TPL_VAR["file"])< 12){?>
	<tr>
		...
		<a href="javascript:add()"><img src="/shop/data/skin/freemart/board/default/img/btn_upload_plus.gif" align=absmiddle></a>
		</td>
		<td id=prvImg0></td>
	</tr>
<?php }?>
...
<?php if($GLOBALS["bdMaxSize"]){?><div>- 파일 업로드 최대 사이즈는 <?php echo byte2str($GLOBALS["bdMaxSize"])?>입니다</div><?php }?>
	* 유사싸이트 소개, 상업성글, 상대방 비방 및 욕설등 불건전한 글은 관리자 임의로 삭제될 수 있습니다.<br/>
 	* 무분별한 게시물 게시를 방지하기 위해 작성자의 IP를 추적할 수 있습니다.
	</div>
...
<tr height=30>
	...
	<input type="image" src="/shop/data/skin/freemart/board/default/img/btn_confirm.jpg" />
	<a href="javascript:document.frmWrite.reset()"><img src="/shop/data/skin/freemart/board/default/img/btn_init.jpg"></a>
	<a href="javascript:history.back()"><img src="/shop/data/skin/freemart/board/default/img/btn_back.jpg"></a>
	</td>
</tr>
</table><p>
</form>
...
function add(){
	...
	tmpHTML = "<input type=file name='file[]' style='width:80%' class=line onChange='preview(this.value," + oTr.id +")'> <a href='javascript:del(" + oTr.id + ")'><img src='/shop/data/skin/freemart/board/default/img/btn_upload_minus.gif' align=absmiddle></a>";
