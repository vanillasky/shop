<?php /* Template_ 2.2.7 2016/05/12 11:24:20 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/board/default/view.htm 000008115 */ 
...
<?php }else{?>-<?php }?>
	...
	<tr>
		<td colspan=3 style="padding:5px 5px 5px 15px; word-wrap:break-word; word-break:break-all; border-bottom:1px dotted #cccccc; text-align:left"><?php echo $TPL_V2["comment"]?></td>
	</tr>
<?php }}?>
	</table>
...
<?php }?>
		...
		<td style="width:15%;">
			<!-- <input type=image src="/shop/data/skin/freemart/board/default/img/board_btn_review.gif"> -->
...
<tr>
	...
	<tr>
		<td>
<?php if($TPL_V1["link"]["modify"]){?><?php echo $TPL_V1["link"]["modify"]?><img src="/shop/data/skin/freemart/board/default/img/btn_modify.jpg"><?php echo $TPL_VAR["link"]["end"]?> <?php }?>
<?php if($TPL_V1["link"]["delete"]){?><?php echo $TPL_V1["link"]["delete"]?><img src="/shop/data/skin/freemart/board/default/img/btn_delete.jpg"><?php echo $TPL_VAR["link"]["end"]?> <?php }?>
<?php if($TPL_VAR["link"]["write"]){?><?php echo $TPL_V1["link"]["reply"]?><img src="/shop/data/skin/freemart/board/default/img/btn_reply.jpg"><?php echo $TPL_VAR["link"]["end"]?><?php }?>
		</td>
		<td align=right>
...
<tr height=20 >
	...
	<td style="border-top:1px solid #ccc; border-bottom:1px solid #ccc;text-align:left"><?php echo $TPL_V1["relation"]["next"]["link"]["view"]?><?php echo $TPL_V1["relation"]["next"]["subject"]?></a></td>
</tr>
<?php }?>
<?php if($TPL_V1["relation"]["prev"]["subject"]){?>
<tr height=20>
	<td style="border-top:1px solid #ccc; border-bottom:1px solid #ccc" >이전글</td>
	<td style="border-top:1px solid #ccc; border-bottom:1px solid #ccc;text-align:left"><?php echo $TPL_V1["relation"]["prev"]["link"]["view"]?><?php echo $TPL_V1["relation"]["prev"]["subject"]?></a></td>
</tr>
<?php }?>
...
<?php if((is_array($TPL_R2=$TPL_V1["relation"]["reply"])&&!empty($TPL_R2)) || (is_object($TPL_R2) && in_array("Countable", class_implements($TPL_R2)) && $TPL_R2->count() > 0)) {foreach($TPL_R2 as $TPL_V2){?>
	<tr>
		<td height=20><?php echo $TPL_V2["gapReply"]?><?php if($TPL_V2["sub"]){?><img src="/shop/data/skin/freemart/board/default/img/board_re.gif" align=absmiddle><?php }?><?php echo $TPL_V2["link"]["view"]?><?php echo $TPL_V2["subject"]?></a></td>
	</tr>
<?php }}?>
	</table>
...
<br><textarea id=examC_<?php echo $TPL_V1["no"]?> style="display:none;width:100%;height:300px;text-align:justify;"><?php echo htmlspecialchars($TPL_V1["contents"])?></textarea>
<?php }}?>
