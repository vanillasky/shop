<?php /* Template_ 2.2.7 2014/07/30 21:42:58 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/board/webzine/view.htm 000007979 */ 
...
<?php if($TPL_VAR["link"]["write"]){?><?php echo $TPL_V1["link"]["reply"]?><img src="/shop/data/skin/freemart/board/webzine/img/board_btn_reply.gif"><?php echo $TPL_VAR["link"]["end"]?><?php }?>
		</td>
		<td align=right>
...
<?php if((is_array($TPL_R2=$TPL_V1["relation"]["reply"])&&!empty($TPL_R2)) || (is_object($TPL_R2) && in_array("Countable", class_implements($TPL_R2)) && $TPL_R2->count() > 0)) {foreach($TPL_R2 as $TPL_V2){?>
	<tr>
		<td height=20><?php echo $TPL_V2["gapReply"]?><?php if($TPL_V2["sub"]){?><img src="/shop/data/skin/freemart/board/webzine/img/board_re.gif" align=absmiddle><?php }?><?php echo $TPL_V2["link"]["view"]?><?php echo $TPL_V2["subject"]?></a></td>
	</tr>
<?php }}?>
	</table>
