<?php /* Template_ 2.2.7 2016/04/30 08:52:22 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/order/order.htm 000041440 */  $this->include_("displayEggBanner");
...
<div class="page-wrapper">
	...
	<div class="page_title_div">
		<div class="page_title">Checkout</div>
		<div class="page_path"><a href="/shop/">HOME</a> &gt; <span class='bold'>Checkout</span></div>
	</div>
	...
	<div class="indiv"><!-- Start indiv -->
		...
		<div style="text-align:left"><img src="/shop/data/skin/freemart/img/common/order_txt_01.gif" border=0></div>
		<?php echo $this->define('tpl_include_file_1',"proc/orderitem.htm")?> <?php $this->print_("tpl_include_file_1",$TPL_SCP,1);?>


<?php if(!$GLOBALS["sess"]){?>
		<!-- 비회원 개인정보 취급방침 내용 -->
		<div style="margin-top:20;"><img src="/shop/data/skin/freemart/img/common/order_txt_non.gif" border=0></div>
...
<?php }?>
		...
		<div class="order-checkout"><img src="/shop/data/skin/freemart/img/common/order_txt_02.gif" border=0 style="vertical-align:middle;"><span style="vertical-align:top; padding:0 0 10px 15px;">*표시는 필수입력 항목입니다.</span></div>
				...
				<td style="padding:10px">
					...
					<table class="order-data">
						...
						<tr>
							...
							<a href="javascript:popup('../proc/popup_address.php',500,432)"><img src="/shop/data/skin/freemart/img/common/btn_zipcode.gif" align=absmiddle></a>
							</td>
						</tr>
						<tr>
							<td></td>
					...
					<tr>
						...
						<td>
							...
							<tr>
								...
								<a href="javascript:popup('../proc/popup_coupon.php',600,700)"><img src="/shop/data/skin/freemart/img/common/btn_coupon.gif" align=absmiddle hspace=2></a><span id="del_coupon" style="visibility:hidden"><a href='javascript:del_coupon();'><img src="/shop/data/skin/freemart/img/common/btn_coupon_del.gif" align=absmiddle hspace=2></a></span>
								</td>
							</tr>
							<tr>
...
<?php }else{?>
							...
							<input type="radio" name="save_mode" value="ncash"> 네이버 마일리지 <img src="<?php echo $GLOBALS["cfg"]["rootDir"]?>/proc/naver_mileage/images/n_mileage_on.png"/><br/>
<?php }?>
							<div id="save_button"><img src="/shop/data/skin/freemart/img/nmileage/n_mileage_use.gif" onClick="javascript:cash_save_use();" class="mileage_button"> 버튼을 클릭해서 <span id="naver-mileage-accum-rate" style="color: #1ec228; font-weight: bold;"></span> 적립받고 사용하세요 <img class="n_mileage" src="/shop/data/skin/freemart/img/nmileage/n_mileage_info2.gif" onclick="mileage_info();"></div>
...
<?php }?>
		...
		<div style="padding:20px" align=center class="noline">
			<!-- 
			<input type="image" src="/shop/data/skin/freemart/img/common/btn_payment.gif">
			<img src="/shop/data/skin/freemart/img/common/btn_cancel.gif" onclick="history.back()" style="cursor:pointer">
			 -->
			 <button class="button-red button-big-wide" onclick="frmOrder.submit();">결제하기</button>
			 <button class="button-dark button-big-wide" onclick="history.back(); return false;">이전으로</button>
		</div>
