<?php /* Template_ 2.2.7 2016/04/29 18:17:19 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/order/order_end.htm 000006802 */ ?>
...
<div class="page-wrapper">
	...
	<div class="page_title_div">
		<div class="page_title">주문완료</div>
		<div class="page_path"><a href="/shop/">HOME</a> &gt; <span class='bold'>주문완료</span></div>
	</div>
	...
	<div class="indiv"><!-- Start indiv -->
		...
		<tr>
			<td align=center style="padding:10 0 10 0"><img src="/shop/data/skin/freemart/img/common/order_complete.gif" border=0></td>
		</tr>
		</table>
		<p></p>
...
<?php }?>
	...
	<div style="width:100%; text-align:center; padding:10">
		<button class="button-red button-big-wide" onclick="location.href='<?php echo url("index.php")?>&'">홈으로</button>
		<button class="button-dark button-big-wide" onclick="location.href='/shop/mypage/mypage_orderlist.php'">주문/배송 조회</button>
	</div>
