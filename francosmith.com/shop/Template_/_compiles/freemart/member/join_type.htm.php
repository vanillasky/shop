<?php /* Template_ 2.2.7 2016/04/12 05:08:27 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/member/join_type.htm 000003874 */ ?>
<?php $this->print_("header",$TPL_SCP,1);?>


<div class="page_title_div">
	<div class="page_title">회원가입</div>
	<div class="page_path"><a href="/shop/">HOME</a> &gt; <span class='bold'>회원가입</span></div>
</div>
...
div.join-member-title {
	...
	margin-top: 5px;
	margin-bottom: 5px;
	background: url('/shop/data/skin/freemart/img/join_title_01.gif') no-repeat;
	height: 23px;
	font-size: 0;
	text-indent: -9999px;
	display: block;
...
div.join-shop div.join-shop-title {
	height: 12px;
	background: url('/shop/data/skin/freemart/img/sns_join_01.gif') no-repeat;
	font-size: 0;
	text-indent: -9999px;
	display: block;
}
...
div.join-shop div.join-shop-select button.btn-join-shop {
	width: 219px;
	height: 54px;
	background: url('/shop/data/skin/freemart/img/btn_shop_join.gif') no-repeat;
	border: none;
	font-size: 0;
	text-indent: -9999px;
	display: block;
...
div.join-sns div.join-sns-title {
	height: 12px;
	background: url('/shop/data/skin/freemart/img/sns_join_02.gif') no-repeat;
	font-size: 0;
	text-indent: -9999px;
	display: block;
}
...
div.join-sns div.join-sns-select div.sns-btn-group button.btn-facebook {
	width: 125px;
	height: 31px;
	background: url('/shop/data/skin/freemart/img/login_sns_facebook.gif') no-repeat;
}
...
<div class="hundred outer-border" style="margin-bottom:20px;">
