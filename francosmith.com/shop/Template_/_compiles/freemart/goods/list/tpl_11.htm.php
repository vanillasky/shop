<?php /* Template_ 2.2.7 2014/07/30 21:42:58 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/goods/list/tpl_11.htm 000002474 */ 
...
<?php if($TPL_V1["goodsnm"]){?><div><a href="<?php echo $TPL_V1["goods_view_url"]?>" title="<?php echo $TPL_V1["goodsnm"]?>"><?php echo goodsimg($TPL_V1["img_s"],$TPL_VAR["size"],'class="'.$TPL_V1["css_selector"].'"')?></a></div><?php }?>
	<div>
		<a href="javascript:void(0);" onClick="fnPreviewGoods_<?php echo $TPL_VAR["id"]?>(<?php echo $TPL_V1["goodsno"]?>);"><img src="/shop/data/skin/freemart/img/common/icon_basket.gif"></a>
	</div>
