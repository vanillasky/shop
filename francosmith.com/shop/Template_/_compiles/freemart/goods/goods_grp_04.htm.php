<?php /* Template_ 2.2.7 2014/07/30 21:42:58 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/goods/goods_grp_04.htm 000007000 */ 
...
<tr>
	<td><img src="/shop/data/skin/freemart/img/common/title_recomgoods.gif" border=0></td>
</tr>
<TR>
	<td class="path">HOME > <B>추천상품</B></td>
</TR>
</TABLE>
<!-- 타이틀이미지 네임 :::
...
<tr>
	...
	<tr>
		...
		<td align=right><img src="/shop/data/skin/freemart/img/common/goodlist_txt_06.gif" align=absmiddle><select onchange="this.form.page_num.value=this.value;this.form.submit()" style="font:8pt 돋움"><?php if($TPL__r_page_num_1){foreach($GLOBALS["r_page_num"] as $TPL_V1){?><option value="<?php echo $TPL_V1?>" <?php echo $GLOBALS["selected"]["page_num"][$TPL_V1]?>><?php echo $TPL_V1?>개씩 정렬<?php }}?></select></td>
	</tr>
	</table>
