...
-->
	...
	<div style="width:98%; margin-left:10px; border-bottom:1px solid #cccccc; padding-bottom:5px;text-align:center;" >
		<span class="popular_keywords; "><?php if($GLOBALS["s_type"]['keyword']){?>인기검색어 : <?php echo $GLOBALS["s_type"]['keyword']?><?php }?></span>
	</div>	
				...
				<td>
					<div class="sort_area">
						<ul id="sort_ul" class="sort_list">
							<li class="" id="sort_price"><a href="javascript:sort('price')"><span></span>낮은 가격순</a></li>
							<li class="" id="sort_price_desc"><a href="javascript:sort('price desc')"><span></span>높은 가격순</a></li>
							...
							<li class="" id="sort_reserve_desc"><a href="javascript:sort('reserve desc')"><span></span>적립금↑</a></li>
							<li class="" id="sort_reserve"><a href="javascript:sort('reserve')"><span></span>적립금↓</a></li>
