<?php /* Template_ 2.2.7 2016/04/30 09:22:04 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/goods/goods_review_register.htm 000010110 */ 
...
function add(){
	...
	tmpHTML = "<input type=file name='file[]' style='width:50%' class=line> <a href=\"javascript:del('"+"tr_"+(tr_num)+"')\"><img src='/shop/data/skin/freemart/img/common/btn_upload_minus.gif' align=absmiddle></a>";
...
<tr>
	...
	<div style="width:100%; background:#000000; border-bottom:2px solid #DDDDDD"><img src="/shop/data/skin/freemart/img/common/popup_title_review.gif"></div>
...
<?php if($GLOBALS["mode"]!='reply_review'){?>
		<tr>
			...
			<td class="noline">
			<input type=radio name=point value=5 class=noline <?php echo $GLOBALS["data"]["point"]['5']?> checked>★★★★★
...
<?php if($TPL_I1== 0){?>
					<a href="javascript:add()"><img src="/shop/data/skin/freemart/img/common/btn_upload_plus.gif" align=absmiddle></a>
<?php }else{?>
<?php if($TPL_V1){?>
					<a href="javascript:del('tr_<?php echo $TPL_I1?>',1)"><img src="/shop/data/skin/freemart/img/common/btn_upload_minus.gif" align=absmiddle></a>
<?php }else{?>
					<a href="javascript:del('tr_<?php echo $TPL_I1?>')"><img src="/shop/data/skin/freemart/img/common/btn_upload_minus.gif" align=absmiddle></a>
<?php }?>
<?php }?>
<?php }?>
<?php if($TPL_V1){?>
