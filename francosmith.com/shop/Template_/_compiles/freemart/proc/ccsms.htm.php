<?php /* Template_ 2.2.7 2014/07/30 21:43:01 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/proc/ccsms.htm 000003240 */ ?>
<div style="width:200px; padding-top:10px; border:solid 1px #e0e0e0; border-width:0 1px 1px 1px;">
	<div align="center"><img src="/shop/data/skin/freemart/img/common/sid_ban_sms.gif"></div>
	...
	<div style="margin:0; padding:15px 15px; text-align:center;">
		...
		<div style="padding-top:3" class="noline" id="avoidSubmit"><input type="image" src="/shop/data/skin/freemart/img/common/sid_btn_sms.gif" alt="보내기"></div>
	</div>
	</form>
</div>
