<?php /* Template_ 2.2.7 2016/04/12 09:16:40 /www/francotr3287_godo_co_kr/shop/data/skin/freemart/proc/orderitem.htm 000008243 */ ?>
<style media="screen">
table.orderitem-list {width:100%;}
table.orderitem-list thead tr th {border-top:2px solid #303030;border-bottom:1px solid #d6d6d6;background:#f0f0f0;height:30px;}
...
<table cellpadding=0 cellspacing=0 class="orderitem-list" >
<?php if($GLOBALS["orderitem_mode"]=="cart"){?><col width=30><?php }?><col width=60><col><col width=60><col width=80><col width=50><col width=80>
<thead>
<tr>
<?php if($GLOBALS["orderitem_mode"]=="cart"){?><th><a href="javascript:void(0);" onClick="chkBox('idxs[]','rev');nsGodo_CartAction.recalc();">선택</a></th><?php }?>
...
<?php }?>
	...
	<div style="margin:5px 0 5px 0;overflow:hidden;height:1px;background:url(/shop/data/skin/freemart/img/common/line2.gif) repeat-x top left;"></div>
...
<?php }?>
<?php if($GLOBALS["orderitem_mode"]=="cart"){?>
	<div style="margin:5px 0 5px 0"><a href="javascript:void(0);" onClick="nsGodo_CartAction.editOption('<?php echo $TPL_I1?>');"><img src="/shop/data/skin/freemart/img/common/btn_check_modify.gif"></a></div>
<?php }?>
	</td>
...
<?php if($GLOBALS["orderitem_mode"]=="cart"){?>
		...
		<tr>
			...
			<td><div style="padding-bottom:2px"><img src="/shop/data/skin/freemart/img/common/btn_plus.gif" onClick="chg_cart_ea(frmCart['ea[]'],'up',<?php echo $TPL_I1?>)" style="cursor:pointer"></div><img src="/shop/data/skin/freemart/img/common/btn_minus.gif" onClick="chg_cart_ea(frmCart['ea[]'],'dn',<?php echo $TPL_I1?>)" style="cursor:pointer"></td>
			<td><input type=image src="/shop/data/skin/freemart/img/common/sbtn_mod.gif"></td>
		</tr>
		</table>
<?php }else{?>
...
<?php }?>
	<tr>
		<td align=right><!-- <?php if($GLOBALS["set"]["emoney"]["emoney_standard"]== 1){?> -->예상적립금<!-- <?php }else{?> -->받으실적립금<!-- <?php }?> --></td>
