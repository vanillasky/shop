<?php /* Template_ 2.2.7 2014/12/23 16:42:11 /www/francotr3287_godo_co_kr/shop/data/skin/standard/goods/goods_qna_list.htm 000005244 */ 
...
<table border=0 cellpadding=0 cellspacing=0>
	<tr>
		<TD style="background: URL(/shop/data/skin/standard/img/common/bar_detail_04.gif) no-repeat;" nowrap width="163" height="24"></TD>
		<TD style="background: URL(/shop/data/skin/standard/img/common/bar_detail_04_bg.gif) repeat-x;" width='90%'><b>(<?php echo $TPL_VAR["qna_count"]?>)</b></TD>
		<TD style="background: URL(/shop/data/skin/standard/img/common/bar_detail_04_right.gif) no-repeat;" nowrap width="10" height="24"></TD>
	</tr>
</table>
...
<?php if($TPL_V1["type"]=='Q'){?>
	<td style="padding-left:0px"><div style="background-image: url(/shop/data/skin/standard/img/common/ico_q.gif); background-repeat:no-repeat;background-position:left 3px;padding:3px 0px 0px 20px;"><?php echo $TPL_V1["subject"]?><?php if($TPL_V1["secretIcon"]){?>&nbsp;<img src="/shop/data/skin/standard/img/common/icn_secret.gif" align=absmiddle><?php }?></div></td>
<?php }else{?>
...
<a href="<?php echo url("goods/goods_qna.php")?>&" target="_parent"><img src="/shop/data/skin/standard/img/common/info_btn_totalview.gif"></a>
<a href="javascript:;" onclick="popup_register( 'add_qna', '<?php echo $GLOBALS["goodsno"]?>' )"><img src="/shop/data/skin/standard/img/common/btn_qna.gif"></a>
</div>
