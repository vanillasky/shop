<?php /* Template_ 2.2.7 2015/10/12 11:03:26 /www/francotr3287_godo_co_kr/shop/data/skin/standard/order/order.htm 000041610 */  $this->include_("displayEggBanner");
...
<tr>
	<td><img src="/shop/data/skin/standard/img/common/title_order_01.gif" border=0></td>
</tr>
<TR>
...
<div><img src="/shop/data/skin/standard/img/common/order_txt_01.gif" border=0></div>
<?php echo $this->define('tpl_include_file_1',"proc/orderitem.htm")?> <?php $this->print_("tpl_include_file_1",$TPL_SCP,1);?>


<?php if(!$GLOBALS["sess"]){?>
<!-- 비회원 개인정보 취급방침 내용 -->
<div style="margin-top:20;"><img src="/shop/data/skin/standard/img/common/order_txt_non.gif" border=0></div>
...
<div style="margin-top:20;"><img src="/shop/data/skin/standard/img/common/order_txt_02.gif" border=0></div>
...
<tr>
	<td width=150 valign=top align=right bgcolor="#F3F3F3"><img src="/shop/data/skin/standard/img/common/order_step_01.gif"></td>
...
<table width=100% style="border:1px solid #DEDEDE" cellpadding=0 cellspacing=0>
<tr>
	<td width=150 valign=top align=right bgcolor="#F3F3F3"><img src="/shop/data/skin/standard/img/common/order_step_02.gif"></td>
	<td style="padding:10px">
	...
	<tr>
		<td>받으실곳</td>
		<td>
		<input type=text name="zonecode" id="zonecode" size="5" class="line" readonly value="<?php echo $TPL_VAR["zonecode"]?>" />
		...
		<a href="javascript:popup('../proc/popup_address.php',500,432)"><img src="/shop/data/skin/standard/img/common/btn_zipcode.gif" align=absmiddle></a>
		</td>
	</tr>
	<tr>
		<td></td>
	...
	<tr>
		<td></td>
		<td>
		<input type=text name=address_sub id="address_sub" class=lineBig value="<?php echo $TPL_VAR["address_sub"]?>" onkeyup="SameAddressSub(this)" oninput="SameAddressSub(this)" label="세부주소">
	...
	<tr>
		<td>전화번호</td>
		<td>
		<input type=text name=phoneReceiver[] value="<?php echo $TPL_VAR["phone"][ 0]?>" size=3 maxlength=3 option=regNum required label="수령자 전화번호"> -
		<input type=text name=phoneReceiver[] value="<?php echo $TPL_VAR["phone"][ 1]?>" size=4 maxlength=4 option=regNum required label="수령자 전화번호"> -
		<input type=text name=phoneReceiver[] value="<?php echo $TPL_VAR["phone"][ 2]?>" size=4 maxlength=4 option=regNum required label="수령자 전화번호">
		</td>
	</tr>
	<tr>
		<td>핸드폰번호</td>
		<td>
		<input type=text name=mobileReceiver[] value="<?php echo $TPL_VAR["mobile"][ 0]?>" size=3 maxlength=3 option=regNum required label="수령자 핸드폰번호"> -
		<input type=text name=mobileReceiver[] value="<?php echo $TPL_VAR["mobile"][ 1]?>" size=4 maxlength=4 option=regNum required label="수령자 핸드폰번호"> -
		<input type=text name=mobileReceiver[] value="<?php echo $TPL_VAR["mobile"][ 2]?>" size=4 maxlength=4 option=regNum required label="수령자 핸드폰번호">
		</td>
	</tr>
	<tr>
		<td>남기실 말씀</td>
...
<?php if($GLOBALS["sess"]){?>
	<tr>
		<td>회원정보 반영</td>
		<td class=noline><input type="checkbox" name="updateMemberInfo" value="y" /> 위 내용을 회원정보에 반영합니다.(주소/전화번호/핸드폰번호)</td>
	</tr>
<?php }?>
	</table>
...
<table width=100% style="border:1px solid #DEDEDE" cellpadding=0 cellspacing=0>
<tr>
	<td width=150 valign=top align=right bgcolor="#F3F3F3"><img src="/shop/data/skin/standard/img/common/order_step_03.gif"></td>
	<td style="padding:10px">
...
<?php if($GLOBALS["sess"]){?>
	...
	<tr>
		...
		<tr>
			...
			<a href="javascript:popup('../proc/popup_coupon.php',600,700)"><img src="/shop/data/skin/standard/img/common/btn_coupon.gif" align=absmiddle hspace=2></a><span id="del_coupon" style="visibility:hidden"><a href='javascript:del_coupon();'><img src="/shop/data/skin/standard/img/common/btn_coupon_del.gif" align=absmiddle hspace=2></a></span>
			</td>
		</tr>
		<tr>
...
<?php }else{?>
			...
			<input type="radio" name="save_mode" value="ncash" onclick="javascript:check_naverNcashUseAble();"> 네이버 마일리지 <img src="<?php echo $GLOBALS["cfg"]["rootDir"]?>/proc/naver_mileage/images/n_mileage_on.png"/><br/>
<?php }?>
			<div id="save_button"><img src="/shop/data/skin/standard/img/nmileage/n_mileage_use.gif" onClick="javascript:cash_save_use();" class="mileage_button"> 버튼을 클릭해서 <span id="naver-mileage-accum-rate" style="color: #1ec228; font-weight: bold;"></span> 적립받고 사용하세요 <img class="n_mileage" src="/shop/data/skin/standard/img/nmileage/n_mileage_info2.gif" onclick="mileage_info();"></div>
...
<table width=100% style="border:1px solid #DEDEDE" cellpadding=0 cellspacing=0>
<tr>
	<td width=150 valign=top align=right bgcolor="#F3F3F3"><img src="/shop/data/skin/standard/img/common/order_step_04.gif"></td>
	<td style="padding:10px">
...
<input type="image" src="/shop/data/skin/standard/img/common/btn_payment.gif">
<img src="/shop/data/skin/standard/img/common/btn_cancel.gif" onclick="history.back()" style="cursor:pointer">
</div>
