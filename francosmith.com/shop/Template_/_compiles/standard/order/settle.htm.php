<?php /* Template_ 2.2.7 2015/08/31 17:51:33 /www/francotr3287_godo_co_kr/shop/data/skin/standard/order/settle.htm 000015632 */ 
...
<tr><td><img src="/shop/data/skin/standard/img/common/title_payment.gif" border=0></td></tr>
...
<img src="/shop/data/skin/standard/img/common/payment_txt_01.gif" border=0>
<!-- 01 주문자정보 -->
...
<a href="javascript:submitSettleForm()"><img src="/shop/data/skin/standard/img/common/btn_payment.gif"></a>
<a href="<?php echo url("order/order.php")?>&"><img src="/shop/data/skin/standard/img/common/btn_back.gif"></a>
</div>
...
function swapSettleButton(){
	if (document.getElementById('avoidDblPay')) document.getElementById('avoidDblPay').innerHTML = "<a href='javascript:submitSettleForm()'><img src='/shop/data/skin/standard/img/common/btn_payment.gif'></a><a href='<?php echo url("order/order.php")?>&'><img src='/shop/data/skin/standard/img/common/btn_back.gif'></a>";
}
...
<?php }?>
	...
	if (document.getElementById('avoidDblPay')) document.getElementById('avoidDblPay').innerHTML = "--- 현재 결제처리중입니다. 잠시만 기다려주세요. ---<br><a href='javascript:swapSettleButton();'><img src='/shop/data/skin/standard/img/common/btn_cancel.gif'></a>";
